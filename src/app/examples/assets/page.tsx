...
export const metadata = {
  title: "폰트 · 아이콘 · 이미지",
  description: "Geist 변수 배선과 lucide 아이콘, next/image 최적화 경로를 실측하는 화면",
}
...
const fontWiring = [
  {
    utility: "font-sans",
    themeVar: "--font-sans",
    source: 'Geist({ variable: "--font-sans" })',
    className: "font-sans",
    note: "create-next-app 기본값(--font-geist-sans)과 다릅니다. shadcn이 생성한 @theme inline이 --font-sans를 참조하기 때문에 일부러 맞춘 것입니다.",
  },
  {
    utility: "font-mono",
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-12 px-4 py-14">
      ...
      >
        ...
        <Alert>
          <TriangleAlertIcon />
          <AlertTitle>결과에 Geist가 없으면 배선이 끊어진 것입니다</AlertTitle>
          <AlertDescription>
            <Code>src/app/layout.tsx</Code>의 <Code>variable</Code> 값을{" "}
            <Code>--font-geist-sans</Code>로 되돌리면, <Code>html {"{ @apply font-sans }"}</Code>가
            정의되지 않은 변수를 가리켜 Geist가 적용되지 않습니다. 그래도 fallback 폰트로 렌더되니
            화면은 멀쩡해 보입니다.
          </AlertDescription>
        </Alert>
      </Section>
