    ...
    <div className="mx-auto max-w-5xl space-y-12 px-4 py-14">
      ...
      >
        ...
        <Alert variant="destructive">
          <TriangleAlertIcon />
          <AlertTitle>다섯 색이 구분되지 않습니다</AlertTitle>
          <AlertDescription>
            <p>
              <Code>components.json</Code>의 <Code>baseColor</Code>가 <Code>neutral</Code>이라 차트
              토큰도 전부 무채색이고, 라이트와 다크 값까지 동일합니다. 데이터 시각화를 붙이기
              전에 색을 직접 정의해야 합니다. 토큰 하나를 바꾸려면{" "}
              <strong>세 군데를 함께</strong> 고쳐야 합니다.
            </p>
...
@theme inline { --color-chart-1: var(--chart-1); } /* 3. 유틸리티 생성 */`}
      ...
      <Section
        ...
        description={
          <>
            <Code>--radius: 0.625rem</Code> 하나를 기준으로 배수를 만듭니다. 한 단계만 예외가
            있습니다.
          </>
        }
      >
