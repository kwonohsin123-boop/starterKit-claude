...
export const colorTokenGroups: ColorTokenGroup[] = [
  ...
  },
  {
    ...
    title: "차트",
    description:
      "baseColor가 neutral이라 다섯 색이 모두 무채색이고, 라이트와 다크 값도 동일합니다.",
    pairs: [
      {
        bgName: "chart-1",
        bgVar: "--chart-1",
  ...
  },
  {
    ...
    pairs: [
      ...
      },
      {
        ...
        note: "다크에서만 보라색 계열로 바뀌어, 유일하게 무채색이 아닌 토큰입니다.",
      },
      {
...
export const radiusScale: RadiusStep[] = [
  ...
  },
  {
    ...
    formula: "@theme에서 오버라이드하지 않음",
    computed: "0.125rem",
    note: "Tailwind 기본값이 그대로 남아 rounded-sm보다 작습니다. 스케일이 어긋나는 유일한 단계입니다.",
  },
  {
